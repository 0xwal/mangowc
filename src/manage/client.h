<<<<<<< conflict 1 of 1
+++++++ lnqwpzlu 0a187597 "feat: ability to move all focused tag's clients to another tag at once :sparkles:" (rebase destination)
%%%%%%% diff from: zzktyxss c0675b00 "chore: don't disable fake fullscreen when toggling off fullscreen :wrench:" (parents of rebased revision)
\\\\\\\        to: rmtkzvpv dbf83376 "feat: allow to make client only focusable using the mouse :sparkles:" (rebased revision)
