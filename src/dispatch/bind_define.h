<<<<<<< conflict 1 of 1
+++++++ ltqqnmoo 9d225a96 "bump version to 0.17.2" (rebase destination)
%%%%%%% diff from: kqpkvnmq 641c36fc "bump version to 0.16.2" (parents of rebased revision)
\\\\\\\        to: ywmmltlo dcbba1cc "feat: add ability to set customize opacity of client :sparkles:" (rebased revision)
